...
license: Apache-2.0 (from github.com/anthropics/skills)
---
...
```bash
.claude/skills/tooling/skill-creator/scripts/init_skill.py <skill-name> --path <output-directory>
```
...
```bash
.claude/skills/tooling/skill-creator/scripts/package_skill.py <path/to/skill-folder>
```

The packaging script validates then creates a .skill file (zip format).
